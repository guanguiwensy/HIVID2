# This version uses trimmomatic-pigz to accelerate the clean process of reads
# 1. Install
...
This configure file difined the indexed referece genomes and alignment parameters used in soap alignment of step3. The users can make their own configure file. But we have involved a configure  named as 'Example_Configure' in the same folder of main.pl. Below is the description of the configuration file:  
